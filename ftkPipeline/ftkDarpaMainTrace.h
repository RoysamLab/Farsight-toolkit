// ############################################################################################################################################################################
#ifndef _ftkMainTrace_h_
#define _ftkMainTrace_h_
// ############################################################################################################################################################################
...
public:
	...
	void runPreprocesing();
	void runTracing();
	
protected:
	void computeSplitConst( rawImageType_8bit::Pointer ImageMontage );
	std::vector< itk::Index<3> > getCentroidList();
	std::vector< itk::Index<3> > getSomaTable( std::vector< itk::Index<3> >, itk::Index<3>, rawImageType_8bit::SizeType, int , int , int );
	std::vector< itk::Index<3> > cropImages( std::vector< rawImageType_uint::Pointer >, std::vector< Data_flo::Pointer > );
