...
for index, DATA_FOLDER in enumerate(DATA_FOLDER_ALL):
	...
	if os.path.isdir(LOCAL_FOLDER):
		...
		if DATA_FOLDER[1]==4:
			...
			PROJE_FILE.write('        <AssociationRule Name="GFP_TOTAL" SegmentationSource="NUCLEAR" Target_Image="gfp" Outside_Distance="0" Inside_Distance="5" Use_Whole_Object="True" Use_Background_Subtraction="True" Use_MultiLevel_Thresholding="False" Number_Of_Thresholds="1" Number_Included_In_Foreground="1" Association_Type="TOTAL" />\n')
			PROJE_FILE.write('        <AssociationRule Name="GFP_AVG" SegmentationSource="NUCLEAR" Target_Image="gfp" Outside_Distance="0" Inside_Distance="5" Use_Whole_Object="True" Use_Background_Subtraction="True" Use_MultiLevel_Thresholding="False" Number_Of_Thresholds="1" Number_Included_In_Foreground="1" Association_Type="AVERAGE" />\n')
			PROJE_FILE.write('        <AssociationRule Name="GFP_SURR" SegmentationSource="NUCLEAR" Target_Image="gfp" Outside_Distance="0" Inside_Distance="5" Use_Whole_Object="True" Use_Background_Subtraction="True" Use_MultiLevel_Thresholding="False" Number_Of_Thresholds="1" Number_Included_In_Foreground="1" Association_Type="SURROUNDEDNESS" />\n')
			PROJE_FILE.write('        <AssociationRule Name="Cy5_TOTAL" SegmentationSource="NUCLEAR" Target_Image="cy5" Outside_Distance="3" Inside_Distance="0" Use_Whole_Object="False" Use_Background_Subtraction="True" Use_MultiLevel_Thresholding="False" Number_Of_Thresholds="1" Number_Included_In_Foreground="1" Association_Type="TOTAL" />\n')
			PROJE_FILE.write('        <AssociationRule Name="Cy5_AVG" SegmentationSource="NUCLEAR" Target_Image="cy5" Outside_Distance="3" Inside_Distance="0" Use_Whole_Object="False" Use_Background_Subtraction="True" Use_MultiLevel_Thresholding="False" Number_Of_Thresholds="1" Number_Included_In_Foreground="1" Association_Type="AVERAGE" />\n')
			PROJE_FILE.write('        <AssociationRule Name="Cy5_SURR" SegmentationSource="NUCLEAR" Target_Image="cy5" Outside_Distance="3" Inside_Distance="0" Use_Whole_Object="False" Use_Background_Subtraction="True" Use_MultiLevel_Thresholding="False" Number_Of_Thresholds="1" Number_Included_In_Foreground="1" Association_Type="SURROUNDEDNESS" />\n')
			PROJE_FILE.write('    </AssociationRules>\n')
			PROJE_FILE.write('    <Classification_MCLR_Rules>\n')
			PROJE_FILE.write('        <Classification_MCLR_Rule ClassColName="mg" ConfThreshold="0.50" TrainingFileName="'+MODEL_FILE_NAME+'" />\n')
			PROJE_FILE.write('    </Classification_MCLR_Rules>\n')
