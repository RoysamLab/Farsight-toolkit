...
class MainMenu:
   ...
   def __init__(self,win):
      ...
      menuDisplayNetwork.add_command(label='Bio Network with k-NN ...', command=self.displayNetwork, underline=0)
      ...
      menuQueries.add_command(label='Enter an XQUERY ...', command=self.notdone, underline=0)
      menuQueries.add_command(label='Built-in Query-1 ...', command=self.notdone, underline=0)
      menuQueries.add_command(label='Built-in Query-1 ...', command=self.notdone, underline=0)
      ...
      top.add_cascade(label='Queries (NOT WORKING YET!)', menu=menuQueries, underline=0)
