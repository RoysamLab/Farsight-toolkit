...
public:
  ...
  virtual bool Push(const char* const code);
  ...
  // Description:
  // Writes a prompt and reads a line.
  // Look at python module documentation for code.InteractiveConsole.raw_input([prompt]) 
  // for further details.
  void RawInput();
