...
{
  PyObject_HEAD
  //vtkPVPythonInteractiveInterpretor* Interpretor;
  ...
  void readline()
    ...
    if (this->Interpretor)
      {
      this->Interpretor->LoadInput();
      //this->Interpretor->Push("__vtkConsole.raw_input('... ')\n");
      }
    }
};

static PyObject* vtkWrite(PyObject* self, PyObject* args);
static PyObject* vtkReadline(PyObject* self, PyObject* args);
...
static PyMethodDef vtkPVPythonInterpretorWrapperMethods[] = {
    ...
    {const_cast<char*>("readline"), vtkReadline, METH_VARARGS, const_cast<char*>("Read line from input")},
    {0, 0, 0, 0}
};
