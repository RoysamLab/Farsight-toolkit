...
main(  int argc, char* argv[] )
{
  ...
  */
  ...
  ImageType::Pointer image = fregl_util_read_image( image_arg(), channel_arg(), true ); 
  ...
  */
  ...
  ImageType2D::Pointer top_image = fregl_util_max_projection( image );
  ...
  image->SetRequestedRegion(region);
  ImageType2D::Pointer bottom_image = fregl_util_max_projection( image );
