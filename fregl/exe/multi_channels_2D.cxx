...
// This program takes a list of 2D gray-scale images, and produce a 2D
// color image. The input file contains the information
...
typedef itk::Image< PixelType, 2 > ImageTypeGray;
...
{
  if (argc<3) {
    std::cerr << "Usage: " << argv[0] << " image_list 2D_color_image";
    return EXIT_FAILURE;
  }
