...
TrackPointFeatureInfoType TrackPointFeatures::Info[M]={
		{ "ver_entropy", "units", "description" },
		{ "correlation_coef", "units", "description" },
		{ "deviation", "units", "description" },
		{ "distance_to_1", "units", "description" },
		{ "distance", "units", "description" },
		{ "inst_speed", "units", "description" },
		{ "volume_change", "units", "description" },
		{ "integ_intensity_change", "units", "description" },
		{ "eccentricity_change", "units", "description" },
		{ "elongation_change", "units", "description" },
		{ "bbox_vol_change", "units", "description" },
		{ "convexity_change", "units", "description" },
		{ "radius_variation_change", "units", "description" },
		{ "surface_area_change", "units", "description" },
		{ "shape_change", "units", "description" },
		{ "surface_gradient_change", "units", "description" },
		{ "interior_gradient_change", "units", "description" },
		{ "surface_intensity_change", "units", "description" },
		{ "interior_intensity_change", "units", "description" },
		{ "intensity_ratio_change", "units", "description" },
