...
void vtkSurfaceRepresentation::SetCellColorArrayName(const char* arrayName)
{
	this->Mapper->SelectColorArray(arrayName);
}

void vtkSurfaceRepresentation::SetCellColorLUT(vtkScalarsToColors* lut)
{
	this->Mapper->SetScalarModeToUseCellFieldData();	
	this->Mapper->SetLookupTable(lut);
}

void vtkSurfaceRepresentation::SetScalarRange(double _arg1, double _arg2)
{
	this->Mapper->SetScalarRange(_arg1,_arg2);
}
