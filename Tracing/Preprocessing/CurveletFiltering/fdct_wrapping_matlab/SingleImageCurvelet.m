...
function x = SingleImageCurvelet(img)
...
for xshift = 1:nshifts
  for yshift = 1:nshifts
    ...
    temp_restored = real(ifdct_wrapping(C,0,N,M));
...
x= uint8(restored_img);
%imwrite(uint8(restored_img),'60_1.tif');
