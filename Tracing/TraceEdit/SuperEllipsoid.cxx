...
//	elevation = -1;
//}
//void SuperEllipsoid::calculateEllipsoid(std::vector<TraceBit> &tips)
//{
//	TraceBit rootbit = tips[0];
//	double Max = 0;
//	//double Min = 1000;
//	//int minIndex = -1;
//	int maxIndex = -1;
...
//		
//	//overall direction
//	/*magnitude = sqrt(pow(components.x,2)+pow(components.y,2)+pow(components.z,2));
//	azimuth = atan(components.y/components.x)*180/PI;
//	double hypotenuse = sqrt(pow(components.x,2)+pow(components.y,2));
//	elevation = atan2(components.z,hypotenuse);*/
//
