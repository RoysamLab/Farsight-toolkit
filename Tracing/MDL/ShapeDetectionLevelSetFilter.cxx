...
int main( int argc, char *argv[] )
{
  ...
  infileSeeds = argv[3];
  fin.open(infileSeeds);
  //cout << "first file name" << infilename << endl;
  if (!fin)  {
     cerr << "couldn't open seed file " << infileSeeds << " for input" << endl;
     return -1;
  }
  ...
  // Read in all the seeds
  int numSeeds = 0;
  while (!fin.eof() )   {
	  fin >> seedPosition[0] >> seedPosition[1] >> seedPosition[2];
	  node.SetIndex( seedPosition );
      seeds->InsertElement( numSeeds, node );
	  numSeeds ++;
  }
  ...
  writer1->SetFileName("ShapeDetectionLevelSetFilterOutput1.mhd");
  ...
  writer2->SetFileName("ShapeDetectionLevelSetFilterOutput2.mhd");
  ...
  writer3->SetFileName("ShapeDetectionLevelSetFilterOutput3.mhd");
  ...
  writer4->SetFileName("ShapeDetectionLevelSetFilterOutput4.mhd");
