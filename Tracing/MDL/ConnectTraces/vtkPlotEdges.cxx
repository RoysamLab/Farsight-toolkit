/*=========================================================================
  ...
  Module:    $RCSfile: vtkPlotEdges.cxx,v $
...
vtkCxxRevisionMacro(Segment, "$Revision: 1025 $");
...
vtkCxxRevisionMacro(Node, "$Revision: 1025 $");
...
vtkCxxRevisionMacro(vtkPlotEdges, "$Revision: 1025 $");
  ...
  vtkInformationVector *outputVector)
{
  ...
  // The filter accepts vtkPolyData as input.
...
{ 
  ...
  this->ExtractSegments(input, segments, nodes);
  this->ConnectSegmentsWithNodes(segments, nodes);
  this->SaveToPolyData(segments, output);
...
void vtkPlotEdges::SaveToPolyData(vtkCollection* segments, vtkPolyData* output)
{
  ...
  cout << "Number of lines: " << output->GetNumberOfLines() << endl;
  cout << "Number of points: " << output->GetPoints()->GetNumberOfPoints() << endl;
}
