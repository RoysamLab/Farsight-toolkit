...
*/
  ...
  if((distOutfile=fopen(argv[14],"wb"))==NULL)
...
//  edge_w[1] = 1.5;
  ...
  std::size_t num_edges = idx_edge;   // sizeof(edge_array) / sizeof(E);
...
/*
  ...
  std::vector<int> component(num_vertices(msTreeBB));
