...
if __name__ == '__main__':
    ...
    data_directory = 'D:\\ucb dataset\\data\\wF5p120307m1s5-t10'
    ...
    for fname in list_of_filenames:
        m = re.search('^([^_]*)_w([0-9]+)_t([0-9]+)\.tif',fname) 
        dataset_id = m.group(1) # set dataset_id
    ...
    #time_points = time_points[0:9] # DEBUG
