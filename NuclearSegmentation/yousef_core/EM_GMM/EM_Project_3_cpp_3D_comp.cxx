...
{   
    ...
    Initialize_Parameters(X,SEEDS,U,Segma,PI,Gamma,num_points,num_components); //Change by Yousef on 04-03-2008: use the same matrix for Gamma and Z
    ...
    {  
        ...
        //parameters  
        Param_Maximization(X,Gamma,U,Segma,PI, num_points, num_components);    
