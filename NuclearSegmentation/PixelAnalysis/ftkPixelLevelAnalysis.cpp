...
void ftk::PixelLevelAnalysis::WriteInitialOutputs(){
	...
	ROIBinImageName    = ROIImageName.substr(0,idx1-1)    + "_bin" +    ROIImageName.substr(idx1);
	TargetBinImageName = TargetImageName.substr(0,idx2-1) + "_bin" + TargetImageName.substr(idx2);
