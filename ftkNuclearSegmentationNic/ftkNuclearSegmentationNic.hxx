...
ftk::nucSecNic::ftkNuclearSegmentationNic< inputPixelType, binaryPixelType, labelPixelType >::ftkNuclearSegmentationNic()
{
	//NucleusSeg = NULL;
...
// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
template < typename inputPixelType, typename binaryPixelType, typename labelPixelType >
void ftk::nucSecNic::ftkNuclearSegmentationNic< inputPixelType, binaryPixelType, labelPixelType >::ResetRealeaseAll()
{
...
// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
template < typename inputPixelType, typename binaryPixelType, typename labelPixelType >
void ftk::nucSecNic::ftkNuclearSegmentationNic< inputPixelType, binaryPixelType, labelPixelType >::ReleaseMemory()
{
...
// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
template < typename inputPixelType, typename binaryPixelType, typename labelPixelType >
bool ftk::nucSecNic::ftkNuclearSegmentationNic< inputPixelType, binaryPixelType, labelPixelType >::setInput(ftk::Image::Pointer dataImage, std::string dataFileName, unsigned int CH, unsigned int T)
{
...
// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
template < typename inputPixelType, typename binaryPixelType, typename labelPixelType >
void ftk::nucSecNic::ftkNuclearSegmentationNic< inputPixelType, binaryPixelType, labelPixelType >::setParameters(std::string paramFileName)
{
...
// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
template < typename inputPixelType, typename binaryPixelType, typename labelPixelType >
void ftk::nucSecNic::ftkNuclearSegmentationNic< inputPixelType, binaryPixelType, labelPixelType >::setParameter(std::string paramName, double value)
{
	bool found = false;
...
// // ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// template < typename inputPixelType, typename binaryPixelType, typename labelPixelType >
// void ftk::nucSecNic::ftkNuclearSegmentationNic< inputPixelType, binaryPixelType, labelPixelType >::setTime( unsigned int T )
// {
// 	_T = T;
// 	time = 1;
// };
...
// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
template < typename inputPixelType, typename binaryPixelType, typename labelPixelType >
void ftk::nucSecNic::ftkNuclearSegmentationNic< inputPixelType, binaryPixelType, labelPixelType >::setParametersDefault( )
{
...
// ------------------------------------------------------------------ PIPELINE 1 ------------------------------------------------------------------
template < typename inputPixelType, typename binaryPixelType, typename labelPixelType >
void ftk::nucSecNic::ftkNuclearSegmentationNic< inputPixelType, binaryPixelType, labelPixelType >::setBinarizeMixPoissonParameters_1(unsigned int numberBins_mixPoisson_1, bool getResultImg_mixPoisson_1)
{
...
template < typename inputPixelType, typename binaryPixelType, typename labelPixelType >
void ftk::nucSecNic::ftkNuclearSegmentationNic< inputPixelType, binaryPixelType, labelPixelType >::setBinarizeMixGaussianParameters_1(unsigned int numberBins_mixGaussian_1, bool getResultImg_mixGaussian_1)
{
...
template < typename inputPixelType, typename binaryPixelType, typename labelPixelType >
void ftk::nucSecNic::ftkNuclearSegmentationNic< inputPixelType, binaryPixelType, labelPixelType >::setBinarizeOtsuParameters_1(unsigned int numberBins_otsuBina_1, bool getResultImg_otsuBina_1){
...
template < typename inputPixelType, typename binaryPixelType, typename labelPixelType >
void ftk::nucSecNic::ftkNuclearSegmentationNic< inputPixelType, binaryPixelType, labelPixelType >::setOtherMethodParameters_1(unsigned int numberBins_otherMethod_1, bool getResultImg_otherMethod_1){
...
template < typename inputPixelType, typename binaryPixelType, typename labelPixelType >
void ftk::nucSecNic::ftkNuclearSegmentationNic< inputPixelType, binaryPixelType, labelPixelType >::setSeedDetectionParameters_1(bool getResultImg_seedDetect_1){
	getResultImg_seedDetect_1 = getResultImg_seedDetect_1; 
};

template < typename inputPixelType, typename binaryPixelType, typename labelPixelType >
void ftk::nucSecNic::ftkNuclearSegmentationNic< inputPixelType, binaryPixelType, labelPixelType >::setMaxClusteringParameters_1(bool getResultImg_maxClust_1){
	_getResultImg_maxClust_1 = getResultImg_maxClust_1;
};


template < typename inputPixelType, typename binaryPixelType, typename labelPixelType >
void ftk::nucSecNic::ftkNuclearSegmentationNic< inputPixelType, binaryPixelType, labelPixelType >::setAlphaExpansionParameters_1(bool getResultImg_alphaExp_1){
	_getResultImg_alphaExp_1 = getResultImg_alphaExp_1;
};

// ------------------------------------------------------------------ PIPELINE 2 ------------------------------------------------------------------
template < typename inputPixelType, typename binaryPixelType, typename labelPixelType >
void ftk::nucSecNic::ftkNuclearSegmentationNic< inputPixelType, binaryPixelType, labelPixelType >::setRadVotingParameters_2(unsigned int voteMinScale_2, unsigned int voteMaxScale_2, bool getResultImg_radVoting_2){
...
template < typename inputPixelType, typename binaryPixelType, typename labelPixelType >
void ftk::nucSecNic::ftkNuclearSegmentationNic< inputPixelType, binaryPixelType, labelPixelType >::setCellShapeIniParameters_2( unsigned int numOutliers_cellShapeIni_2, bool getResultImg_cellShapeIni_2){
	_numOutliers_cellShapeIni_2 = numOutliers_cellShapeIni_2;
	_getResultImg_cellShapeIni_2 = getResultImg_cellShapeIni_2;
};

template < typename inputPixelType, typename binaryPixelType, typename labelPixelType >
void ftk::nucSecNic::ftkNuclearSegmentationNic< inputPixelType, binaryPixelType, labelPixelType >::setGVFforceParameters_2( double mu_GVFforce_2, double iter_GVFforce_2, bool getResultImg_GVFforce_2 ){
...
template < typename inputPixelType, typename binaryPixelType, typename labelPixelType >
void ftk::nucSecNic::ftkNuclearSegmentationNic< inputPixelType, binaryPixelType, labelPixelType >::setAnotherForceParameters_2( double alpha_1_AnotherForce_2, double alpha_2_AnotherForce_2, bool getResultImg_AnotherForce_2 ){
...
template < typename inputPixelType, typename binaryPixelType, typename labelPixelType >
void ftk::nucSecNic::ftkNuclearSegmentationNic< inputPixelType, binaryPixelType, labelPixelType >::setLevelSetParameters_2( double betha_1_LevelSet_2, double betha_2_LevelSet_2 ){
...
// ------------------------------------------------------------------ PIPELINE 3 ------------------------------------------------------------------
template < typename inputPixelType, typename binaryPixelType, typename labelPixelType >
void ftk::nucSecNic::ftkNuclearSegmentationNic< inputPixelType, binaryPixelType, labelPixelType >::setLevlSetParameters_3( double betha_1_LevlSet_3, double betha_2_LevlSet_3 ){
...
// ###############################################################################################################################################################
template < typename inputPixelType, typename binaryPixelType, typename labelPixelType >
void ftk::nucSecNic::ftkNuclearSegmentationNic< inputPixelType, binaryPixelType, labelPixelType >::runSegmentImage(){
...
// // ############################################################################################################################################################################
// template < typename inputPixelType, typename binaryPixelType, typename labelPixelType >
// void ftk::nucSecNic::ftkNuclearSegmentationNic< inputPixelType, binaryPixelType, labelPixelType >::ftkBinarizeMixPoisson(unsigned int numberBins, bool getResultImg)
// //void ftk::nucSecNic::ftkNuclearSegmentationNic< inputPixelType, binaryPixelType, labelPixelType >::ftkBinarizeMixPoisson(unsigned int numberBins, bool getResultImg)//, const std::vector<double> 
// {
