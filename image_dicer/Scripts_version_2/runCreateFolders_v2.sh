...
if [ ! -d $LOCAL_DATASET_PATH_TRACE_SOMASDDIVIDED ]; then
	mkdir $LOCAL_DATASET_PATH_TRACE_SOMASDDIVIDED
else
	echo L1n: The content of the path $LOCAL_DATASET_PATH_TRACE_SOMASDDIVIDED will be erased
	cd $LOCAL_DATASET_PATH_TRACE_SOMASDDIVIDED
# 	rm -rf $LOCAL_DATASET_PATH_EXE/*
	cd $ACTUAL_DIRECTORY
fi
