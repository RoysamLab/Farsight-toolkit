...
writerLog = MyWriter(sys.stdout, 'logFile.log')
...
OVE_RESULTS = 0	# If 0 the results will be keep
...
for DATA_FOLDER in DATA_FOLDER_ALL:
	...
	#FARSIGHT_BIN = '/data/nicolas/farsight_updated/bin-relnooptimized'
	#FARSIGHT_BIN_EXE = '/data/nicolas/farsight_updated/bin-relnooptimized/exe'
