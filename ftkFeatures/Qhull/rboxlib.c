...
#define MAXdim 200
#define PIval 3.1415926535897932384
  ...
  /* ============= apex of 'Zn' distribution + gendim =============== */
    ...
    for (i=0; i < numpoints; i++) {
      ...
      /* ============= point of 'l' distribution =============== */
        ...
        coord[0]= cos(2*PIval*i/(numpoints - 1));
        coord[1]= sin(2*PIval*i/(numpoints - 1));
