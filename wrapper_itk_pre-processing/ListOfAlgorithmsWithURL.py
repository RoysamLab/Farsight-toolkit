...
from ListOfItems import *

class ListOfAlgorithmsWithURL(ListOfItems):
	...
	def OnListBoxSelect(self, event):
		...
		self.__helplink = wx.lib.agw.hyperlink.HyperLinkCtrl(
				self.panel, -1, label = "Help on " + selName + " Filter", 
                URL = url1, pos = (250, 40))

		if self.__advancedhelplink:
			self.__advancedhelplink.Destroy()
		self.__advancedhelplink = wx.lib.agw.hyperlink.HyperLinkCtrl(
